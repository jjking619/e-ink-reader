...
例子1：
    如果你是的3.7inch e-paper (V1)，那么你应该在编译时加上 EPD=epd3in7
        sudo make clean
        sudo make EPD=epd3in7
例子2：
    如果你是2.9inch e-paper (B) (V1)，由于2.9寸的B型和C型是公用的驱动代码，那么你应该在编译时加上 EPD=epd2in9bc
        sudo make clean
        sudo make EPD=epd2in9bc
例子3：
    如果你是7.5inch e-Paper (V2)，那么你应该在编译时加上 EPD=epd7in5V2
        sudo make clean
